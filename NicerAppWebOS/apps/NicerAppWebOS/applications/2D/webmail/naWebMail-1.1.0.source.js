                    ...
                    var header = 
                        '<div class="header" style="position:absolute;height:65px;width:calc(100% - 20px);background:rgba(0,0,0,0.4);border-radius:8px;">'
                            +'<span id="btnBack_fromWebMail" class="vividButton_icon_50x50 tooltip" title="Go back" alt="Go back"  onclick="if (!$(this).is(\'.disabled\')) na.themeEditor.selectTextShadowSettings(event)">'
                                ...
                                +'<img class="vividButton_icon_imgButtonIconBG_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton_iconBackground.png"/>'
                                +'<img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/btnBack.png"/>'
                            +'</span>'            
                            +'<span id="btnAddServer" class="vividButton_icon_50x50 tooltip" title="Add server" alt="Add server"  onclick="if (!$(this).is(\'.disabled\')) na.apps.loaded[\'app.2D.webmail.v1.0.0\'].addServer(event);">'
                                +'<span class="vividButton_icon_borderCSS_50x50"></span>'
                                +'<img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.greenYellow.png"/>'
                                +'<img class="vividButton_icon_imgButtonIconBG_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton_iconBackground.png"/>'
                                +'<img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/blue-plus-icon-12.png"/>'
                            +'</span>'            
                            +'<span id="btnEditServer" class="vividButton_icon_50x50 tooltip" title="Edit server settings" alt="Edit server settings"  onclick="if (!$(this).is(\'.disabled\')) na.apps.loaded[\'app.2D.webmail.v1.0.0\'].editServer(event);">'
                                +'<span class="vividButton_icon_borderCSS_50x50"></span>'
                                +'<img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.blue1a.png"/>'
                                +'<img class="vividButton_icon_imgButtonIconBG_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton_iconBackground.png"/>'
                                +'<img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/settings.png"/>'
                            +'</span>'            
                            +'<span id="btnDeleteServer" class="vividButton_icon_50x50 tooltip" title="Delete server" alt="Delete server"  onclick="if (!$(this).is(\'.disabled\')) na.apps.loaded[\'app.2D.webmail.v1.0.0\'].deleteServer(event)">'
                                +'<span class="vividButton_icon_borderCSS_50x50"></span>'
                                +'<img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.red1a.png"/>'
                                +'<img class="vividButton_icon_imgButtonIconBG_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton_iconBackground.png"/>'
                                +'<img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/btnTrashcan2.png" style="width:auto;height:28px;left:12px;top:10px"/>'
                            +'</span>'            
        ...
        var ac = {
            ...
            success : function (data, ts, xhr) {
                ...
                $('#wmEmail').contents().find('body').prepend(
                    '<link type="text/css" rel="StyleSheet" href="/NicerAppWebOS/domainConfigs/nicer.app/index.css?c=20210711_231212">'
                    +'<link type="text/css" rel="StyleSheet" href="/NicerAppWebOS/domainConfigs/nicer.app/index.dark.css?c=20210711_231212">'
                );
