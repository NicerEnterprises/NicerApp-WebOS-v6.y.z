        ...
        */
            ...
            tinymce.init({
                ...
                content_css: [
                    ...
                    '/NicerAppWebOS/domainConfigs/'+na.site.globals.domain+'/index.css?now='+(new Date().getTime()),
                    '/NicerAppWebOS/domainConfigs/'+na.site.globals.domain+'/index.dark.css?now='+(new Date().getTime())
                ],
