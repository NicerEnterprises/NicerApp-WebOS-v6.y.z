...
<div id="document_headers" class="vividDialogPopup">
    <div class="sections">
        ...
        <div class="navbar_section">
                <span id="url0" class="vividTheme_input_urls" style="width:auto;padding-right:30px;"></span>
                ...
                <div id="url1_dropdown" class="vividDropDownBox" style="display:inline-block;margin-top:-12px;width:auto;"></div>
    ...
    <div id="document_navBar" class="navbar" style="display:flex">
        <div class="sections">
            <div class="navbar_section shown">
                    ...
                    <img id="btnSettingsHeaders" class="navbar_button" src="/NicerAppWebOS/siteMedia/btnSettingsHeaders.png" onclick="na.blog.onclick_editHeaders(event);"/>
                    <img id="btnTree" class="navbar_button" src="/NicerAppWebOS/siteMedia/btnTree.png" onclick="na.blog.onclick_btnTree(event);"/>
            </div>
            <div class="navbar_section">
