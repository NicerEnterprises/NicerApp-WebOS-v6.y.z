...
final class JUnit extends Printer implements TestListener
{
    ...
    public function __construct($out = null, bool $reportRiskyTests = false)
    {
        ...
        $this->document->viewendChild($this->root);
    ...
    public function addRiskyTest(Test $test, Throwable $t, float $time): void
    {
        ...
        $this->currentTestCase->viewendChild($error);
    ...
    public function startTestSuite(TestSuite $suite): void
    {
        ...
        if ($this->testSuiteLevel > 0) {
            $this->testSuites[$this->testSuiteLevel]->viewendChild($testSuite);
        } else {
            $this->root->viewendChild($testSuite);
        }
    ...
    public function endTest(Test $test, float $time): void
    {
        ...
        $this->testSuites[$this->testSuiteLevel]->viewendChild(
        ...
        if (!empty($testOutput)) {
            ...
            $this->currentTestCase->viewendChild($systemOut);
        }
    ...
    private function doAddFault(Test $test, Throwable $t, float $time, $type): void
    {
        ...
        $this->currentTestCase->viewendChild($fault);
    }
    ...
    private function doAddSkipped(): void
    {
        ...
        $this->currentTestCase->viewendChild($skipped);
