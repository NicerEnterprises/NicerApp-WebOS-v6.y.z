...
final class Totals
{
    ...
    public function __construct(\DOMElement $container)
    {
        ...
        $container->viewendChild($this->linesNode);
        $container->viewendChild($this->methodsNode);
        $container->viewendChild($this->functionsNode);
        $container->viewendChild($this->classesNode);
        $container->viewendChild($this->traitsNode);
    }
