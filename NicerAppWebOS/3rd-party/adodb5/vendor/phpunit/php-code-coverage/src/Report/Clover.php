...
final class Clover
{
    ...
    public function process(CodeCoverage $coverage, ?string $target = null, ?string $name = null): string
    {
        ...
        $xmlDocument->viewendChild($xmlCoverage);
        ...
        $xmlCoverage->viewendChild($xmlProject);
        ...
        foreach ($report as $item) {
            ...
            foreach ($classes as $className => $class) {
                ...
                $xmlClass->viewendChild($xmlMetrics);
            }
            ...
            $xmlFile->viewendChild($xmlMetrics);

            if ($namespace === 'global') {
                $xmlProject->viewendChild($xmlFile);
            } else {
                if (!isset($packages[$namespace])) {
                    ...
                    $xmlProject->viewendChild($packages[$namespace]);
                }

                $packages[$namespace]->viewendChild($xmlFile);
            }
        }
        ...
        $xmlProject->viewendChild($xmlMetrics);
