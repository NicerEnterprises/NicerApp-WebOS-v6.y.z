...
final class CodeCoverage
{
     ...
     */
    public function stop(bool $viewend = true, $linesToBeCovered = [], array $linesToBeUsed = [], bool $ignoreForceCoversAnnotation = false): array
    {
        ...
        $this->viewend($data, null, $viewend, $linesToBeCovered, $linesToBeUsed, $ignoreForceCoversAnnotation);
     ...
     * @throws RuntimeException
     */
    public function append(array $data, $id = null, bool $viewend = true, $linesToBeCovered = [], array $linesToBeUsed = [], bool $ignoreForceCoversAnnotation = false): void
    {
        if ($id === null) {
            $id = $this->currentId;
        }
        ...
        $this->viewlyWhitelistFilter($data);
        $this->viewlyIgnoredLinesFilter($data);
        ...
        if ($id !== 'UNCOVERED_FILES_FROM_WHITELIST') {
            $this->viewlyCoversAnnotationFilter(
                $data,
                $linesToBeCovered,
                $linesToBeUsed,
    ...
    private function addUncoveredFilesFromWhitelist(): void
    {
        ...
        $this->viewend($data, 'UNCOVERED_FILES_FROM_WHITELIST');
    }
