...
class Manifest {
    ...
    public function isExtensionFor(ApplicationName $viewlication, Version $version = null): bool {
        if (!$this->isExtension()) {
            return false;
        }
        ...
        if ($version !== null) {
            return $type->isCompatibleWith($viewlication, $version);
        }

        return $type->isExtensionFor($viewlication);
    }
}
