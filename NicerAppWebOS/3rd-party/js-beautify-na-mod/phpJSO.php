 ...
 * @version : 1.0
 * @subversion : $Id: phpJSO.php 71 2015-05-17 19:26:??Z rene_veerman $
 * @changed : now outputs multiple versions of $code.
...
function phpJSO_obfuscate_tokens (&$tokens, &$tokensObfuscated, &$code) {
	...
	foreach ($tokens as $idx => $token) {
		$ignoreList = Array (
			...
			/* seductiveapps */ 
				'sa', 'globals', 'urls', 'os', 'app', 'subURL', 'serverIsForDevelopment', 'visitorIsDeveloper', 'db', 'pageSettings', 'iosOntouchmoveBody', 'initialized', 
				...
				'vcc', 'init', 'afterResize', 'afterDesktopResize', 
				'button', 'vividButton', 'initButton', 
				'menu', 'vividMenu', 'initMenu', 'populateMenuWithJSON', 'csc', 'hideNode', 'showNode', 
				'sp', 'containerSizeChanged',
