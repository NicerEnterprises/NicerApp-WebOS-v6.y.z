...
curl https://$DOMAIN_TLD/NicerAppWebOS/domainConfigs/$DOMAIN_TLD/ajax_backgrounds_recursive.php > /dev/null
echo "NOW RE-INITIALIZING .../NicerAppWebOS/siteCache/backgrounds.json"
curl https://$DOMAIN_TLD/NicerAppWebOS/domainConfigs/$DOMAIN_TLD/ajax_backgrounds.php > /dev/null
