...
//debugger;
            ...
            if (it.model && p && p.model) {
                ...
                min = 4, m0 = (it.level-2) < 5 ? it.level-2 : 4, m1a = 400, m1 = 2500/m0, m2 = 2500/m0, m2a = 400, n = 2, n1 = p.leftRight * p.column, n2 = p.upDown * p.row, o = 600, q = 500, s = 1,
                ...
                it.model.position.x = Math.round(
                    ...
                    + (it.level > min ? (u1 * m1a)+(it.column*m1) : (it.column*m1))
                ...
                it.model.position.y = Math.round(
                    ...
                    + (it.level > min ? (w1 * m2a)+(it.row*m2) : (it.row*m2))
