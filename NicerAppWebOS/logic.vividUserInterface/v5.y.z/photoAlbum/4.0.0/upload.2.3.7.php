...
$targetDir = 
        ...
        .DIRECTORY_SEPARATOR.$naWebOS->domain.DIRECTORY_SEPARATOR.$_GET['basePath']
        .$relativePath;
...
createDirectoryStructure (dirname($thumbPath), $filePerms_ownerUser, $filePerms_ownerGroup, $filePerms_perms_publicWriteableExecutable);
